/**
 * react-dom-client.esm.js — ReactDOM/client 19.0.0 pour Cash Country Studio PWA
 * Fournit createRoot et hydrateRoot.
 */
import React from '/libs/react.esm.js';
window.__REACT_CJS__ = window.__REACT_CJS__ || React;

const __mod = { exports: {} };
const __exp = __mod.exports;
const process = { env: { NODE_ENV: 'production' } };
function require(id) {
  if (id === 'react') return window.__REACT_CJS__;
  if (id === 'react-dom') return window.__REACTDOM_CJS__ || __mod.exports;
  if (id === 'scheduler') return window.__SCHEDULER_CJS__ || {};
  throw new Error('[react-dom-client.esm] require non supporté: ' + id);
}
...
window.__REACTDOM_CJS__ = __mod.exports;
const RDC = __mod.exports;
export default RDC;
