/**
 * react.esm.js — React 19.0.0 pour Cash Country Studio PWA
 * Wrapper ESM autour du build CJS production. Zéro dépendance CDN.
 */
const __mod = { exports: {} };
...
// Stocker globalement pour react-dom (qui require('react'))
window.__REACT_CJS__ = __mod.exports;

const R = __mod.exports;
export default R;
export const {
