/**
 * react-dom-client.esm.js — ReactDOM/client 19.0.0
 */
import '/libs/react.esm.js';
import '/libs/scheduler.esm.js';
import '/libs/react-dom.esm.js';

const ReactDOMClient = (function() {
  'use strict';
  const exports = {};
  ...
  function require(id) {
    ...
    if (id === 'react-dom') return window.__REACTDOM_CJS__ || {};
    return {};
  }
/**
 * @license React
